...
Java_com_example_administrator_myjni_MainActivity_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_example_administrator_myjni_MainActivity_FromatstringFromJNI(
...
//    return env->NewStringUTF(hello.substr(0,3).c_str());
...
//     char  buff[128] = env->GetStringUTFChars(phoneid,0);
//    char* pBuff = buff  ;


  //  strlcpy(aa,str,3);    //可以复制
...
//    env-> GetStringUTFRegion(phoneid,6,8,cc);
   ...
   // env->ReleaseStringChars(phoneid,chr1);
